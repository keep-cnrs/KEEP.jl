...
function plot_solution(x, p; kwargs...)
    sol = BK._get_shooting_solution(
        d_bvp.cache, reshape(x, 2, disc.M), 1, @set params.a = p
    )
...
prob = BifurcationKit.BVP.BVPBifProblem(
    d_bvp, x0, params, (@optic _.a); record_from_solution, plot_solution
)
...
br = continuation(prob, PALC(), optc; plot=true, verbosity=0, normC=norminf)
...
# BRANCH SWITCHING
br2 = continuation(
    br, 1, ContinuationPar(optc; max_steps=30); autodiff=false, bothside=true
)
...
#━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# CODIMENSION 2
bp_codim = continuation(
    br,
    1,
    (@optic _.b),
    ContinuationPar(optc; p_min=-1.0);
    verbosity=0,
