...
println("05.4.5_Equilibriums.jl@18
The differentiation here is broken, running on MacOS works, debugging on MacOS raises a 'DualMismatch' error from ForwardDiff, and the github worker has an error with ReverseDiff.")
...
if false
    ...
    display(gif(anim_grouped, fps=.5))
