...
function update_shoot_init_rootfind(optim_vars::ComponentArray{<:FD.Dual}, vbp)
    return update_shoot_init_rootfind(getfield.(optim_vars, :value), vbp)
end
...
function update_shoot_init_compute_limit_cycle(optim_vars::ComponentArray{<:FD.Dual}, vbp)
    return update_shoot_init_compute_limit_cycle(getfield.(optim_vars, :value), vbp)
end
...
function update_shoot_init_integration(optim_vars::ComponentArray{<:FD.Dual}, vbp)
    return update_shoot_init_integration(getfield.(optim_vars, :value), vbp)
end
...
function obj_one_integration(dτ_sign::Union{typeof(+),typeof(-)})
    ...
    obj_one_integration(optim_vars, vbp) =
        obj_one_integration(as_component_array(optim_vars), vbp)
