...
plot(aspect_ratio=:equal, xlabel="\$y\$ (m)", ylabel="\$z\$ (m)", xtick=-20:5:20, ytick=5:2.5:10, size=plot_size(3))
...
annotate!(0.375, avg_opt + 2, Plots.text(f"+{100*(avg_opt/avg_0 - 1):.0f}%", ANNOTATIONFONTSIZE, c_opt, :center, rotation=0, family=FONT))
