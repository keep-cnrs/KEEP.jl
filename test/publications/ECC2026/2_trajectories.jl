...
function main()
    ...
    plot(;
        title="Two different limit cycles",
        aspect_ratio=:equal,
        axis=false,
        xlabel=L"\alpha",
        ylabel=L"\tau",
    ...
    surface(
        ...
        alpha=0.3,
        color=:diff,
        title="A trajectory and its symmetry (opposite phase)",
        axis=false,
    )
    ...
    if plot_sym
        plot!(
            invert(xyz_torus.(t, Ref(sol_plus), true))...;
            lw=lw,
            label="sym(+)",
            c=1,
            alpha=0.7,
        ...
        plot!(
            invert(xyz_torus.(t, Ref(sol_minus), true))...;
            lw=lw,
            label="sym(-)",
            c=2,
            alpha=0.7,
